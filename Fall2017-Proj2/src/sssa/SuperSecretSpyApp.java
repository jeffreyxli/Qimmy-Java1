...
public class SuperSecretSpyApp extends javax.swing.JFrame {
	...
	private javax.swing.JRadioButton jRadioButtonRot32;
	...
	public SuperSecretSpyApp() {
		...
		buttonGroupSystem.add(jRadioButtonRot32);
	...
	private void buttonSpyItActionPerformed(java.awt.event.ActionEvent evt) {
		if (!jRadioButtonEncrypt.isSelected() 
		...
		else if (!jRadioButtonRot32.isSelected() 
			...
			if (jRadioButtonEncrypt.isSelected()) {
				jTextFieldCipher.setText(
						CryptoCode.rot32(jTextFieldPlain.getText()));
			}
			else {
				jTextFieldPlain.setText(
						CryptoCode.rot32(jTextFieldCipher.getText()));
			}
		}
	...
	private void jRadioButtonSystemStateChanged(javax.swing.event.ChangeEvent evt) {                                               
		if (jRadioButtonRot32.isSelected()) {
	...
	private void initComponents() {
		...
		jRadioButtonRot32 = new javax.swing.JRadioButton();
		...
		jRadioButtonRot32.setText("Rotate32");
		jRadioButtonRot32.addChangeListener(new javax.swing.event.ChangeListener() {
			public void stateChanged(javax.swing.event.ChangeEvent evt) {
																...
																.addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
																		...
																		.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
																				...
																				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
																						...
																						.addComponent(jRadioButtonRot32)
