...
public class Interview {
	...
	public static void main(String[] args) {
		...
		if (total > 900)
		{
			System.out.print("Greetings " + name + ", your age is " + total + " months.");
		}
		else if (total < 120)
		{
			System.out.print("Hello " + name + ", your age is only " + total + " months.");
		}
		else 
		{
			System.out.print("Howdy " + name + ", you are " + total + " months old.");
		}
